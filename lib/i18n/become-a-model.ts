...
const BG: BecomeAModelStrings = {
  ...
  heading: "Стани модел",
  introLead:
    "Ще се радваме да получим вашата кандидатура, ако отговаряте на изискванията ни:",
  ...
  femaleWear:
    "Жени — черни шорти или легинг, или дънки, с топ и токчета; може и бански",
  maleWear: "Мъже — черни прилежни дънки, риза и маратонки; може и бански",
  ...
  errors: {
    ...
    bustRequired: "Мерката за бюст е задължителна",
    bustInvalid: "Бюст — валидно число в cm, макс. 3 цифри (напр. 80–90)",
